...
$adminSections = [
  ...
  [
    'title' => 'スタッフを整える',
    'lead'  => '勤務予定の確認から、登録・招待、一覧チェックまでを5列のまま順番に並べています。',
    ...
    'items' => [
      ...
      [
        ...
        'tag'  => $lineUnlinkedCount > 0 ? ('3. 未連携 ' . $lineUnlinkedCount . '件') : '3. 要確認',
        'tone' => 'warn',
      ],
      [
        'icon' => '📄',
      ...
      [
        'icon' => '🪴',
        'title' => '店長向け育成指示',
        'desc' => '接客タイプ、弱点、ミッション状況から今の声かけを確認します。',
        'href' => dashboard_link('/wbss/public/admin/cast_growth.php', $storeId),
        'tag'  => '3. 育成',
        'tone' => 'primary',
      ],
    ],
...
$managerSections = [
  ...
  [
    'title' => 'スタッフを整える',
    'lead'  => '登録や編集、招待、連携チェックを5列のまま順番に並べています。',
    'class' => 'dash-section-staff',
    'items' => [
      [
        'icon' => '👥',
      ...
      [
        ...
        'desc' => 'まだ連携していない人だけを絞り込んで確認します。',
        'href' => dashboard_link('/wbss/public/store_casts_list.php', $storeId, ['filter' => 'line_unlinked']),
        'tag'  => $lineUnlinkedCount > 0 ? ('2. 未連携 ' . $lineUnlinkedCount . '件') : '2. 要確認',
        'tone' => 'warn',
      ],
      [
        'icon' => '📄',
