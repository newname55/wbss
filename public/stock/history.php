...
$right = '
  ...
  <a class="btn" href="/seika-app/public/stock/list.php">在庫一覧</a>
  ...
  <div class="card">
    <div style="display:flex; gap:12px; flex-wrap:wrap; align-items:flex-end; justify-content:space-between;">
      ...
      <div style="display:flex; gap:10px; flex-wrap:wrap;">
        <a class="btn" href="/seika-app/public/stock/history.php">条件クリア</a>
      </div>
    </div>
              ...
              <td style="padding:10px; border-bottom:1px solid var(--line);">
                ...
                <div class="muted" style="margin-top:4px;">
                  <a class="btn" style="min-height:auto; padding:6px 10px;"
                     href="/seika-app/public/stock/move.php<?= h($ptype!==''?('?ptype='.$ptype.'&q='.urlencode($prodLinkQ)) : ('?q='.urlencode($prodLinkQ))) ?>">
                    この商品を入出庫
                  </a>
                </div>
              </td>
