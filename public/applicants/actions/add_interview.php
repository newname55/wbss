...
try {
  service_applicants_add_interview($pdo, $personId, $_POST, $actorUserId);
  header('Location: /wbss/public/applicants/detail.php?id=' . $personId . '&msg=' . rawurlencode('面接記録を追加しました'));
  exit;
} catch (Throwable $e) {
