...
try {
  service_applicants_change_status($pdo, $personId, $action, $_POST, $actorUserId);
  header('Location: /wbss/public/applicants/detail.php?id=' . $personId . '&msg=' . rawurlencode('状態を更新しました'));
  exit;
} catch (Throwable $e) {
