...
try {
  service_applicants_move_store($pdo, $personId, $_POST, $actorUserId);
  header('Location: /wbss/public/applicants/detail.php?id=' . $personId . '&msg=' . rawurlencode('店舗移動を登録しました'));
  exit;
} catch (Throwable $e) {
